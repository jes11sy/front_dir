              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-700 hover:border-red-400 hover:bg-red-50 transition-all duration-200 shadow-sm hover:shadow group"
                  >
                ...
                <button 
                  ...
                  className="px-4 py-2.5 text-white rounded-xl transition-all duration-200 hover:shadow-lg text-sm font-medium bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 flex items-center gap-2"
                >
            ...
            {showFilterDrawer && (
              <>
                ...
                <div className="fixed top-0 right-0 h-full w-full max-w-sm bg-white shadow-2xl z-50 animate-slide-in-right overflow-hidden flex flex-col">
                  {/* Header */}
                  <div className="flex items-center justify-between p-5 border-b border-gray-100 bg-gradient-to-r from-red-500 to-red-600">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {quickPeriods.map((period) => (
                          <button
                            ...
                            className="px-4 py-2.5 bg-gray-50 hover:bg-red-50 border border-gray-200 hover:border-red-300 rounded-xl text-sm font-medium text-gray-700 hover:text-red-700 transition-all duration-200"
                          >
                            {period.label}
                          </button>
                        ))}
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm transition-all"
                          />
                        </div>
                        <div>
                  ...
                  <div className="p-5 border-t border-gray-100 bg-gray-50 space-y-3">
                    <button
                      ...
                      className="w-full px-4 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-xl font-semibold transition-all duration-200 hover:shadow-lg flex items-center justify-center gap-2"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
