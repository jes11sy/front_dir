          ...
          <div className="backdrop-blur-lg shadow-2xl rounded-2xl p-8 border" style={{backgroundColor: '#15282f', borderColor: '#114643'}}>
            ...
            <div className="mb-6">
              <Button
                ...
                className="p-2"
                style={{color: 'white'}}
                onMouseEnter={(e) => (e.target as HTMLElement).style.backgroundColor = '#2a6b68'}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          required
                          className="flex-1 bg-gray-800 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:border-transparent"
                          onFocus={(e) => (e.target as HTMLElement).style.boxShadow = '0 0 0 2px #2a6b68'}
                          onBlur={(e) => (e.target as HTMLElement).style.boxShadow = 'none'}
                        />
                        <Button
                      ...
                      <div className="flex gap-2">
                        <div className="relative flex-1">
                          <Input
                            ...
                            required
                            className="w-full pr-10 bg-gray-800 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:border-transparent"
                            onFocus={(e) => (e.target as HTMLElement).style.boxShadow = '0 0 0 2px #2a6b68'}
                            onBlur={(e) => (e.target as HTMLElement).style.boxShadow = 'none'}
                          />
                          <button
                      ...
                      {formData.passportFile ? (
                        <div className="space-y-2">
                          <div className="flex items-center justify-center space-x-2">
                            ...
                            <span className="text-white font-medium">{formData.passportFile.name}</span>
                          </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div>
                            <p className="text-white font-medium">Загрузить паспорт</p>
                      ...
                      {formData.contractFile ? (
                        <div className="space-y-2">
                          <div className="flex items-center justify-center space-x-2">
                            ...
                            <span className="text-white font-medium">{formData.contractFile.name}</span>
                          </div>
                          <p className="text-gray-400 text-sm">
                        ...
                        <div className="space-y-2">
                          ...
                          <div>
                            <p className="text-white font-medium">Загрузить договор</p>
                            <p className="text-gray-400 text-sm">PDF, JPG, PNG до 10MB</p>
                          </div>
                          <input
                            type="file"
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                <Button
                  ...
                  onMouseEnter={(e) => !isSubmitting && availableCities.length > 0 && ((e.target as HTMLElement).style.backgroundColor = '#1a5a57')}
                  onMouseLeave={(e) => !isSubmitting && availableCities.length > 0 && ((e.target as HTMLElement).style.backgroundColor = '#2a6b68')}
                >
